		...
		<div class="issues__posts mdl-grid">
			<div class="issues-card-wide mdl-card mdl-shadow--2dp">
				<div class="mdl-card__title mdl-shadow--2dp">
					<h2 class="mdl-card__title-text mdl-color-text--grey-800">이슈 생성 권한 없음.</h2>
				</div>
				...
				<div class="mdl-card__supporting-text">
					<ul class="issue-list mdl-list">
							...
							<span class="mdl-list__item-sub-title">
								해당 프로젝트에 멤버가 아니어서 프로젝트에 이슈를 생성할 수 없습니다.
								아래의 '참여하기'를 누르시면, 멤버로 등록됩니다.  		
							</span>
							</li>
							<span class="mdl-list__item-primary-content"> <a href="/projects/${projectId}/join">
							<strong>참여하기</strong></a>
							</span>
					</ul>
				</div>
			</div>
